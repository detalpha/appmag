...
return [
    ...
    */
    ...
    'title' => 'Aplikasi Cek Arus Gangguan',
    ...
    */
    ...
    'menu' => [
        ...
        ['header'   => 'main_navigation'],
        [
            'text'  => 'Manage Gardu Induk',
            'url'   => 'master/gardu',
            'icon'  => 'fas fa-industry',
            // 'can'   => 'manage-garduinduk',
        ],
        [
            'text'  => 'Manage Penyulang',
            'url'   => 'master/penyulang',
            'icon'  => 'fas fa-sitemap',
            // 'can'   => 'manage-penyulang',
        ],
        [
            'text'  => 'Cek Arus Gangguan',
            'url'   => 'proses/cekgangguan',
        ...
        [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/adminlte/plugins/iCheck/square/blue.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/adminlte/plugins/iCheck/icheck.min.js',
                ],
            ],
        ],
        [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/adminlte/dist/js/FileSaver.min.js',
                ],
            ],
        ],
    ],
