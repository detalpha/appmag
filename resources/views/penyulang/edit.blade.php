...
@section('content_header')
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Ubah Penyulang</li>
    </ol>
@stop
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="code" id="code" placeholder="Masukan Kode Penyulang"  value="{{ $data->code }}" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="name" id="name" placeholder="Masukan Nama Penyulang" value="{{ $data->name }}" required>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-8">
                      <select class="form-control select2" id="gardu_induks_id" name="gardu_induks_id" style="width: 100%;">
                        @foreach ($datanya["garduinduk"] as $item)
                          <option {{ ( $data->gardu_induks_id == $item->id ? "selected" : "") }} value="{{ $item->id }}">{{ $item->code }} - {{ $item->name }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-8">
                      <select class="form-control selectallowclear" id="gardu_hubung_id" name="gardu_hubung_id" style="width: 100%;">
                        @foreach ($datanya["garduhubung"] as $item)
                          <option {{ ( $data->gardu_hubung_id == $item->id ? "selected" : "") }} value="{{ $item->id }}">{{ $item->code }} - {{ $item->name }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="arus_hs_3_phs" id="arus_hs_3_phs" placeholder="Masukan Arus HS. 3 PHS" value="{{ $data->arus_hs_3_phs }}" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="teg_primer" id="teg_primer" placeholder="Masukan Tegangan Primer" value="{{ $data->teg_primer }}" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="teg_skunder" id="teg_skunder" placeholder="Masukan Tegangan Sekunder" value="{{ $data->teg_skunder }}" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="imp_trafo" id="imp_trafo" placeholder="Masukan Impendasi Trafo" value="{{ $data->imp_trafo }}" required>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12 table-responsive">
                      <table class="tabel table table-bordered" id="tbl_spot_penyulang">
                        ...
                        <tbody>
                          @foreach ($data->penyulang_spot as $item)
                            <tr>
                              <th>{{ $item->header }}</th>
                              <th>{{ $item->code }}</th>
                              <th>{{ $item->name }}</th>
